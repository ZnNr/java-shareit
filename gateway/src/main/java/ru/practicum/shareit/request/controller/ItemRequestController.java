...
public class ItemRequestController {
    ...
    @PostMapping
    public ResponseEntity<Object> addItemRequest(@RequestHeader(name = Constants.headerUserId) Long requesterId,
    ...
    public ResponseEntity<Object> getItemRequest(@RequestHeader(name = Constants.headerUserId) Long requesterId,
    ...
    public ResponseEntity<Object> getOwnItemRequests(
            @RequestHeader(name = Constants.headerUserId) Long requesterId) {
